# -*- coding: utf-8 -*-
"""
Created on Sat Oct 28 04:27:28 2017
...
"""-------------------------------------------------------------------------------------------
     ...
     In Parameter   :  k -- Number of clusters
                       ...
                       iterations --  number of ireations
   ...
   -------------------------------------------------------------------------------------------
"""
def kmeans(k,datset,centroids,iterations) :
...
#centroids = initialise(k,dataset)

#Manually enter centroids
dp= [3,5,9]
centroids = np.array([dataset[dp[0]-1],dataset[dp[1]-1],dataset[dp[2]-1]])
centroids = np.array([dataset[0],dataset[1],dataset[2]])


#K Means algorithm implementation
iterations=10
print("Iterations" ,iterations)
result = kmeans(k,dataset,centroids,iterations)
